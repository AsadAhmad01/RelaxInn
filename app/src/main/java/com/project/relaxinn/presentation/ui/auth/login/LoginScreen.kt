        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                CustomTextField(
                    ...
                    onVisibilityChange = { viewModel.onEvent(LoginEvent.TogglePasswordVisibility) },
                ...
                Row(
                    ...
                    Row(
                        ...
                        modifier = Modifier.clickable {
                            viewModel.onEvent(LoginEvent.RememberMeChanged(!state.isRememberMeChecked))
                        }) {
                        Checkbox(
                ...
                CustomButton(
                    title = "Sign in",
                    onclick = { onLoginClick() /*viewModel.onEvent(LoginEvent.LoginClicked) */ },
                    modifier = Modifier
                )
